                                        ...
                                        for (unsigned int dof_trial_index = 0;
                                            ...
                                            output->at(dof_test.global_index, dof_trial.global_index) +=
                                                    ...
                                                    integrand(cell_test, cell_trial, dof_test_index,
                                                              dof_trial_index, uv_test, uv_trial, unitary_test_u, unitary_test_v, unitary_trial_u, unitary_trial_v, kernel_value);
                                        }
                                    }
                                }
                            }
...
//                                                              uv_trial, unitary_test_u, unitary_test_v, unitary_trial_u, unitary_trial_v, kernel_value);
                                            temp_matrix(dof_test_index, dof_trial_index) += full_jacobian*integrand(cell_test, cell_trial,dof_test_index,dof_trial_index, uv_test,uv_trial, unitary_test_u, unitary_test_v, unitary_trial_u, unitary_trial_v, kernel_value);
                                        }
                                    }
                                }
                            }
